    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 p-12 text-white">
        <div className="relative z-20">
          <Link to="/" className="flex items-center gap-2 text-lg font-semibold hover:opacity-80 transition-opacity">
            <img src="/assets/logo-header-white.png" alt="Asikaso Logo" className="h-14" />
          </Link>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          {/* Mobile Logo */}
          <Link to="/" className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-12 hover:opacity-80 transition-opacity">
            <img src="/assets/logo-header.png" alt="Asikaso Logo" className="h-14" />
          </Link>
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground text-sm">
              {isSignUp ? "Enter your details to register" : "Please enter your details"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 bg-background border-border/60 focus:border-blue-500"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-background border-border/60 focus:border-blue-500"
                />
                <button
                  type="button"
            ...
            {error && (
              <div className="p-3 text-sm text-red-400 bg-red-50 border border-red-200 rounded-lg">
                {error}
              </div>
            )}
            ...
            <Button 
              ...
              disabled={isLoading}
            >
              {isLoading ? (isSignUp ? "Signing up..." : "Signing in...") : (isSignUp ? "Sign Up" : "Log in")}
            </Button>
          </form>
          ...
          <div className="mt-6">
            <Button 
              variant="outline" 
              className="w-full h-12 bg-background border-border/60 hover:bg-slate-50"
              type="button"
            >
          ...
          <div className="text-center text-sm text-muted-foreground mt-8">
            ...
            <Link to={isSignUp ? "/login" : "/signup"} className="text-blue-600 font-medium hover:underline">
